  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#F5E8FF] border-t border-black/5 relative overflow-hidden">
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {/* Soft Pink-Purple Gradient CTA Card matching Kazi Reference */}
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: false, margin: '-100px' }}
          variants={cardVariants}
          className="p-10 sm:p-16 rounded-[40px] bg-gradient-to-br from-white via-[#F5E8FF] to-[#EBD5FF] border border-white shadow-2xl text-center space-y-8"
        >
          {/* Eyebrow badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-[#181124] font-utility text-[10px] font-bold uppercase tracking-widest border border-black/10 shadow-sm">
            • GET IN TOUCH
          </div>

          {/* Main Headline */}
          <h2 className="font-body text-4xl sm:text-6xl font-black text-[#181124] tracking-tight leading-tight max-w-3xl mx-auto">
            Have a story worth <span className="text-[#A124DB]">moving</span>?
          </h2>

          <p className="font-body text-base sm:text-lg text-[#6D637C] max-w-xl mx-auto">
            Got footage that needs editing, or want to shoot something together? Message me.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 max-w-lg mx-auto">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full font-body font-bold text-xs uppercase tracking-wider text-white bg-[#181124] hover:bg-[#A124DB] transition-all shadow-md"
            >
              <Sparkles className="w-4 h-4 text-[#E052FF]" />
              Build Instant Inquiry
            </button>
            ...
            <a
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-7 py-4 rounded-full font-body font-bold text-xs uppercase tracking-wider text-[#181124] bg-white border border-black/15 hover:border-[#A124DB] transition-all shadow-sm"
            >
